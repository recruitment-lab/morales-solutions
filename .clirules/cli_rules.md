...
# CLI Policy
- Do not run any commands that modify the repository history (git add, commit, push, etc.) without explicit instruction.
- If a task requires an `npm install`, provide the command and wait for approval.
